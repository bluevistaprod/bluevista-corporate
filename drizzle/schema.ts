...
export const testimonials = mysqlTable("testimonials", {
  ...
  sector: mysqlEnum("sector", ["communication", "events", "immersion"]).notNull(),
  ...
  videoUrl: varchar("video_url", { length: 512 }),
  imageUrl: varchar("image_url", { length: 512 }),
  status: mysqlEnum("status", ["pending", "approved", "published", "rejected"]).default("pending").notNull(),
  allowWebsite: int("allow_website").default(0).notNull(),
  allowGoogle: int("allow_google").default(0).notNull(),
  allowTrustpilot: int("allow_trustpilot").default(0).notNull(),
  allowSocial: int("allow_social").default(0).notNull(),
  googleReviewId: varchar("google_review_id", { length: 255 }),
  trustpilotReviewId: varchar("trustpilot_review_id", { length: 255 }),
  linkedinPostId: varchar("linkedin_post_id", { length: 255 }),
  featured: int("featured").default(0).notNull(),
  domain: varchar("domain", { length: 64 }).default("com").notNull(),
