...
export const VILLES: PageVille[] = [
  ...
  },
  {
    ...
    competence: "video-corporate-film-dentreprise",
    texte: [
      "Nous maitrisons tous les stades de réalisation et production vidéo : conception, storyboard, tournage, montage, motion design, animation 3D. Nos équipes se déplacent sur l’ensemble du territoire suisse pour la réalisation de votre vidéo d’entreprise avec du matériel haut de gamme et des experts dans leur domaine. Nous adaptons nos équipes à toute taille de projet. Qu’il s’agisse d’une simple interview en région genevoise face au jet d’eau ou d’un film corporate multi-techniques, nous saurons vous accompagner. Plus qu’un prestataire de tournage à Genève, nous sommes une agence de création de contenus complète à même de vous accompagner dans tous vos projets. Cela autant pour du tournage, du motion design, du drone ou de l’ animation 3D.",
      "Envie de nous suivre nous et notre travail ? Envie de travailler avec une boite de prod lyonnaise ? Suivez nous sur nos réseaux sociaux !",
      "Notre équipe est composée d’experts dans leurs domaines : concepteurs / réalisateurs / caméramen / monteurs / graphistes. Notre agence vidéo de Genève intervient sur l’ensemble du territoire suisse avec une grande expérience en communication des entreprises de la région. Notre agence est en évolution permanente. La réalisation de vidéo est notre domaine ainsi que tous les nouveaux supports. Que votre projet soit de diffuser votre film sur votre site internet, lors d’une convention d’entreprise ou bien dans un casque de réalité virtuelle, nous saurons vous accompagner. Vous souhaitez découvrir nos compétences ? Allez faire un tour sur notre page réalisations. Vous découvrirez un ensemble de projets vidéos réalisés en suisse.",
    ],
    specificites: [
      {
